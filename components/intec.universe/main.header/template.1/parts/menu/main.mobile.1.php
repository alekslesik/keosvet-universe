...
$sPhoneDisplay = $arResult['CONTACTS']['ADVANCED'] ? ArrayHelper::shift($arResult['CONTACTS']['SELECTED'])['PHONE']['DISPLAY'] : ArrayHelper::shift($arResult['CONTACTS']['SELECTED'])['DISPLAY'];
