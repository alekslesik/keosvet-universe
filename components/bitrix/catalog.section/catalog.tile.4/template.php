...
?>
        ...
        <div class="catalog-section-item-base">
            ...
            <div class="section-main-element-param">
                ...
                <div class="element-param">
                    <img src="/local/templates/universe_s1/images/logos/power.png" title=<?= $powerName ?> alt=<?= $powerName ?> class="icon-led">
                    <span class="power"><?= $powerValue ?></span>
                    <span class="unit">Вт</span>
                </div>
                <div class="element-param">
                    <img src="/local/templates/universe_s1/images/logos/lumen.png" title=<?= $lumenName ?> alt=<?= $lumenName ?> class="icon-led" style="vertical-align: middle;">
                    <span class="flow" style="vertical-align: middle;"><?= $lumenValue ?></span>
                    <span class="unit">Лм</span>
                </div>
                <div class="element-param">
                    <img src="/local/templates/universe_s1/images/logos/ip.png" title=<?= $ipName ?> alt=<?= $ipName ?> class="icon-led">
    ...
    <?php if ($arVisual['GIFTS']['SHOW'] && $arVisual['GIFTS']['POSITION'] === 'middle' && !$bGiftShowed) { ?>
        <?php if (
            $iItemsCount > $arVisual['COLUMNS']['DESKTOP'] && $arVisual['COLUMNS']['DESKTOP'] == $iCounter ||
